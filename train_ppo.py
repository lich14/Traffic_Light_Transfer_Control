...
if __name__ == '__main__':
    ...
    csv_dir = f'./csv_files/PPO/points_{args.points}_difficult_{args.difficult}/reward_para_{args.reward_para}'
    ...
    writer = SummaryWriter(
        f"runs/ppo/points_{args.points}_difficult_{args.difficult}/reward_para_{args.reward_para}_seed_{args.seed}")
    ...
    for main_step in range(2000):
        ...
        adv = adv.squeeze(-1)
        actor_loss_list, critic_loss_list, entropy_loss_list, comm_norm_list, comm_norm_list = [], [], [], [], []
        ...
        try:
            for _ in range(args.ppo_epoch):
                ...
                optimizer.zero_grad()
                (action_loss + args.entropy_w * entropy_loss + 2 *
                 value_loss + args.comm_norm_w * comm_norm).backward()
        ...
        if main_step % 100 == 0:
            ...
            save_path = f"./models_ppo/points_{args.points}_difficult_{args.difficult}/reward_para_{args.reward_para}_seed_{args.seed}/"
